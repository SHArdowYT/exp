...
from types_sha import User


def _signed_in(user: User) -> str:
...
def home_page(handler: BaseHTTPRequestHandler, user: Optional[User] = None) -> None:
    """Serves the home page."""
    body = _signed_in(user).encode() if user else _SIGNED_OUT.encode()
